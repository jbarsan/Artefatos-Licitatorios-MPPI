...
> [!IMPORTANT]
> Esta estrutura está direcionada para as contratações de TIC está de acordo com o disposto na Instrução Normativa IN SGD/ME nº 94, de 23 de dezembro de 2022, integrado aos elementos obrigatórios e não obrigatórios da Lei nº 14.133/2021 (Nova Lei de Licitações) e complementado pelas disposições da Resolução CNMP nº 283/2024 e MOTec para órgãos do Ministério Público, além de seguir o modelo disponível no sistema ETP Digital (compras.gov.br).

---

### MODELO OBRIGATÓRIO MP PARA CONTRATAÇÃO/AQUISIÇÃO DE BENS E SERVIÇOS DE TIC: ETP Digital + MOTec CNMP 283/2024

Este modelo foi elaborado seguindo as orientações da Coordenadoria de Licitações e Contratos do MPPI e está de acordo com todas as normas e leis que regem os processos de licitações e contratos.

***Por favor, leiam atentamente e sigam as instruções, assim o artefato estará de acordo e evitará retrabalhos.***

---

## INFORMAÇÕES BÁSICAS (ETP Digital)
...
> [!NOTE]
> O número do ETP não é obrigatório caso o mesmo esteja sendo elaborado seguindo outro modelo que não seja o fornecido pelo ETP Digital (compras.gov.br), pois o ETP Digital gera o número automaticamente.
...
<tr>
    <td style="text-align:center;">XX/XX/2025</td>
...
<table border="1" style="width:100%;">
    <tr>
        <td style="text-align:center"><b>Código do ITEM</b></td>
        <td style="text-align:center"><b>Descrição da solução 1</b></td>
    </tr>
    <tr>
        <td style="text-align:center"><b>Código do ITEM</b></td>
        <td style="text-align:center"><b>Descrição da solução 2</b></td>
    </tr>
</table>
...
- Ressalta-se que o ETP tem como finalidade permitir à Equipe de Planejamento a identificação e análise das soluções disponíveis no mercado capazes de atender às necessidades do MPPI. Assim, não se deve indicar previamente uma solução específica, salvo nos casos em que já exista estudo técnico anterior que aponte para uma alternativa devidamente considerada.
...
> [!NOTE]
> Todas as unidades requisitantes devem ser listadas abaxo (quando aplicável).

***Exemplo:***

<table border="1" style="width:100%;">
    <tr>
        <th style="text-align:center"><b>Área requisitante</b></th>
        <th style="text-align:center"><b>Responsável</b></th>
    </tr>
    <tr>
        <td style="text-align:center">COORDENADORIA DE TECNOLOGIA DA INFORMAÇÃO (CTI)</td>
        <td style="text-align:center">Nome do Coordenador da CTI</td>
    </tr>
    <tr>
        <td style="text-align:center">GRUPO DE ATUAÇÃO ESPECIAL DE COMBATE AO CRIME ORGANIZADO (GAECO)</td>
        <td style="text-align:center">Nome do Coordenador do GAECO</td>
    </tr>
</table>

### 6. Necessidades de negócio (IN 94/2022 art.11 I; MOTec; ETP Digital)

> [!NOTE]
> A necessidade do negócio define o problema para o qual o analista de negócios está tentando encontrar uma solução. A maneira como a necessidade do negócio é definida determina quais soluções alternativas serão consideradas, quais partes interessadas serão consultadas e quais abordagens de solução serão avaliadas.
>
> As necessidades de negócio (Não confundir com os requisitos de negócio) segundo o Corpo de Conhecimento de Análise de Negócios (Guia BABOK. 2.0), são metas de mais alto nível, objetivos ou necessidades da organização. Descrevem as razões pelas quais um projeto foi iniciado, os objetivos que o projeto vai atingir e as métricas que serão utilizadas para medir o seu sucesso.
>
...
> [!NOTE]
> As necessidades tecnológicas, são o "como" a tecnologia precisa estar estruturada para viabilizar aquelas necessidades de negócio.
>
> A lista deve estar coerente com as informações que foram passadas nas "Necessidades de Negócio".
>
...
>
> Os Requisitos de Negócio são a tradução das necessidades em condições ou características mínimas que a solução contratada deve atender.
>
...
>
> É preciso se atentar ao tipo de serviço ou bem que está sendo contratado/adquirido. Alguns devem seguir normas específicas, por exemplo:
>
> Contratação de empresa para fornecimento de serviços do tipo "Fábrica de Software" deve seguir a Portaria SGD/ME nº 5.651, de 22 de junho de 2022. Contratação de Outsourcing de impressão deve estar de acordo com a Portaria SGD/MGI nº 370, de 8 de março de 2023, que institui o Modelo de Contratação de Serviços de Outsourcing de Impressão e assim por diante.
...
>
> Podem ser estabelecidos requisitos para definição de cronograma das atividades de desenvolvimento da solução, definindo-se marcos para cada etapa do projeto" - MOTec
...
>
> Ex: Migração de ambiente sem indisponibilidade de sistemas; Entrega da solução plenamente funcional; Prazo experimental; Definição de janela de monitoramento após a implantação (funcionamento provisório/ de horário para implantação etc.)" - MOTec
...
> ***A relação de requisitos apresentada contempla os pontos previstos no MOTec e na Instrução Normativa SGD/ME nº 94/2022 para contratações de TIC. Ressalta-se que não se trata de uma lista exaustiva, podendo ser ampliada conforme as necessidades específicas da contratação.***

---

> ***O MOTec apresenta recomendações que visam prevenir direcionamentos e reduzir riscos de impugnações. Recomenda-se fortemente a observância dessas orientações, especialmente na elaboração de ETPs voltados à contratação de software, contratações que envolvam indicação de marca ou processos de adesão a Atas de Registro de Preços.***
...
> Identificar serviços ou bens disponíveis no mercado que possam atender às necessidades do órgão.

10.2. Contratações similares em outros órgãos públicos

> Verificar se outros órgãos já utilizam soluções que poderiam ser compartilhadas ou adaptadas para atender às necessidades do MPPI, incluindo serviços que possam ser cedidos ou compartilhados.

10.3. Alternativas

> Avaliar a existência de alternativas no mercado capazes de atender às demandas do órgão, considerando custo, eficiência e adequação técnica.

10.4. Software público

> No caso de aquisição de softwares ou sistemas, verificar se há soluções disponíveis no [Catálogo de Software Público](https://softwarepublico.gov.br/social/search/software_infos) que possam atender às necessidades institucionais.

10.5. Adequação de ambiente

> Analisar a necessidade de ajustes ou adaptações no ambiente corporativo para receber os itens adquiridos ou contratados, garantindo compatibilidade e operacionalidade.

10.6. Modelos de prestação

> Avaliar qual modelo de prestação de serviço é mais vantajoso, considerando eficiência, flexibilidade e custos envolvidos.

10.7. Aquisição versus serviço

> Comparar as vantagens de adquirir os bens ou serviços de forma permanente em relação à contratação como serviço terceirizado (outsourcing), considerando impactos financeiros e operacionais.

10.8. Ampliação/substituição

> Identificar se a contratação atenderá à ampliação da capacidade existente ou à substituição de recursos já obsoletos, assegurando planejamento estratégico da infraestrutura.
...
> [!NOTE]
> Pesquisa preliminar de valores seguindo sempre as orientações da IN SEGES/ME Nº 65/2021.
>
> MOTec:
>
...
> Não esquecer:
>
> - Justificativa para a escolha do fornecedor (nos casos de pesquisas diretas);
> - Verificar contratações similares em outros órgãos públicos. (Obrigatório)
...
- Estabelecer critérios e procedimentos para o recebimento provisório e definitivo do objeto contratado incluindo a realização de inspeções detalhadas para verificar a conformidade com as especificações técnicas e funcionalidades. Qualquer inconformidade deverá ser registrada e comunicada imediatamente à CONTRATADA para providências corretivas.
- Preparar relatórios periódicos pelos Fiscais do Contrato, documentando o progresso da entrega, os resultados das inspeções, os testes realizados, as não conformidades identificadas e as ações corretivas tomadas. Esses relatórios serão utilizados para monitorar a execução contratual e tomar decisões informadas sobre eventuais ajustes necessários ao longo da vigência do contrato.
...
> [!NOTE]
> "Definir obrigações do contratante e da contratada na execução dos serviços ou no fornecimento de bens, em conformidade as etapas apresentadas na rotina de execução de forma lógica e prática." - MOTec
...
> [!NOTE]
> "Apresentação, quando possível, de quantitativos iniciais de contratação considerando demandas acumuladas, bem como projeção de contratações/fornecimentos futuros." - MOTec
>
